...
data = requests.get("https://commons.wikimedia.org/w/api.php?action=query&titles=File:" +
                    dic["国旗画像"]+"&prop=imageinfo&iiprop=url&format=json").text
print(re.search(r"\"url\":\"(.+?)\"", data).group(1))
